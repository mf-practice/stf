    ...
    on: {
      ...
      proxyRes: responseInterceptor(async (responseBuffer, proxyRes, req, res) => {
        return await new Promise(function (resolve, reject) {
            ...
            let downloadHref = Object.values(parsedResponse.resources)[0].href
          ...
          .catch(NoManifestError, err => {
            ...
            return 'Unable to retrieve manifest'
          })
          ...
          .catch(NotOwnedDevice, err => {
            ...
            return 'You cannot install on this device. Not owned by you'
          })
          .catch(err => {
            proxyRes.statusCode = 400
            return 'Failed to install apk, ' + err;
          })
          .then(err => {
            return JSON.stringify({
              success: false,
