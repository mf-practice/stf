...
const devicesProxy = require('../api/controllers/devices.proxy')
...
var securityHandler = require('../api/helpers/securityHandlers').accessTokenAuth
const {
  json
} = require('body-parser');
...
module.exports = function (options) {
  ...
  app.use('/api/v1/devices/:serial/install', securityHandler)
  app.use('/api/v1/devices/:serial/install', devicesProxy.createFileSizeValdiationMiddleware({
    maxSize: options.maxApkSize
  }))
  app.use('/api/v1/devices/:serial/install', devicesProxy.createInstallApkProxy({
    storageUrl: options.storageUrl,
    storagePluginApkPath: options.storagePluginApkPath
  }))
